...
//    private static final String SANDBOX_BASE_URL = "https://api-uat.doku.com";
    ...
    private static final String PRODUCTION_BASE_URL = "https://api.doku.com";
    ...
    private static final String DIRECT_DEBIT_CARD_UNBINDING = "/direct-debit/core/v1/registration-card-unbind";
    ...
    public static String getDirectDebitCardUnbindingUrl(boolean isProduction) {
        return getBaseUrl(isProduction) + DIRECT_DEBIT_CARD_UNBINDING;
    }
